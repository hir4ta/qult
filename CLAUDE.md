...
- Stop: review-gate active → HARD block. Other checks (unchecked Next Steps, self-review, incomplete spec) → CONTEXT reminder only (no block). stop_hook_active=true → allow (DEC-4 infinite loop prevention)
