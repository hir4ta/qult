...
- Delta template: templates/delta.md.tmpl (Change Summary, Files Affected (ADDED/MODIFIED/REMOVED), Rationale, Impact Scope, Test Plan, Rollback Strategy) — no FR-N/EARS, change-focused
