...
qult は 14 スキルと 5 エージェントで完全な開発ワークフローを提供:
...
| **plan-evaluator** | Opus | Feasibility, Completeness, Clarity | 実装前の計画品質評価 |
| **spec-reviewer** | Opus | Completeness, Accuracy | 実装が計画に合致しているか検証 |
| **quality-reviewer** | Opus | Design, Maintainability | コード品質とエッジケースの評価 |
| **security-reviewer** | Opus | Vulnerability, Hardening | OWASP Top 10 セキュリティレビュー |
