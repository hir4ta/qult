...
import {
  SpecDir, parseSize, parseSpecType, detectSize, filesForSize, VALID_SLUG,
  readActiveState, writeActiveState, switchActive, completeTask,
  setReviewStatus, reviewStatusFor, removeTask,
} from '../types.js';
...
describe('ActiveState management', () => {
  ...
  it('writes and reads active state', () => {
    writeTestState({ primary: 'task-a', tasks: [{ slug: 'task-a', started_at: '2026-01-01T00:00:00Z' }] });
