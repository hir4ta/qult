---
name: doctor
description: Check qult health for the current project. Verifies state files, rules installation, and MCP server connectivity. Use after initial setup or when something seems broken. NOT for checking session progress (use /qult:status instead).
user-invocable: true
---
